 ...
 const RegisterPage = () => {
    ...
    return (
        <div className="min-h-screen bg-slate-300 flex items-center justify-center p-4">
            <div className="max-w-md w-full bg-stone-50 rounded-3xl shadow-2xl p-8 border border-indigo-100">
                ...
                {error && (
                    <div className="bg-red-50 border-l-4 border-indigo-100 text-red-700 p-4 mb-6 rounded-r-xl flex items-center animate-pulse">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-sm font-bold text-slate-800 ml-1">User</label>
                        <div className="relative">
                            <User className="absolute left-3 top-1/2 -translate-y-1/2 text-slate-800 w-5 h-5" />
                            <input
                                type="text"
                                name="userName"
                                required
